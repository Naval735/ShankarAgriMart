    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PestDiseases", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GST = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false, defaultValue: 18m),
                    ...
                    SafetyPrecautions = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CropProducts", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_InventoryTransaction_Type", "[TransactionType] IN ('StockIn', 'StockOut', 'Adjustment')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CropId = table.Column<int>(type: "int", nullable: false),
                    PestDiseaseId = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductRecommendations_Crops_CropId",
                        column: x => x.CropId,
                        principalTable: "Crops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductRecommendations_PestDiseases_PestDiseaseId",
                        column: x => x.PestDiseaseId,
                        principalTable: "PestDiseases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "DeletedAt", "IsDeleted", "RoleName", "UpdatedAt", "UpdatedBy" },
                values: new object[,]
                {
                    { 1, new DateTime(2026, 8, 11, 11, 0, 21, 490, DateTimeKind.Utc).AddTicks(6690), null, null, false, "Admin", null, null },
                    { 2, new DateTime(2026, 8, 11, 11, 0, 21, 490, DateTimeKind.Utc).AddTicks(6694), null, null, false, "Customer", null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CropProducts_CropId_ProductId",
                table: "CropProducts",
                columns: new[] { "CropId", "ProductId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductRecommendations_CropId_PestDiseaseId_ProductId",
                table: "ProductRecommendations",
                columns: new[] { "CropId", "PestDiseaseId", "ProductId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductRecommendations_PestDiseaseId",
                table: "ProductRecommendations",
                column: "PestDiseaseId");
